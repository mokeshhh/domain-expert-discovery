...
router.post('/', async (req, res) => {
  try {
    ...
    const stopWords = [
      'i', 'need', 'want', 'show', 'the', 'any', 'is', 'to', 'please', 'expert', 'experts',
      'here', 'me', 'require', 'could', 'would', 'can', 'tell', 'a', 'an', 'of', 'for',
      'with', 'on', 'at', 'and', 'in', 'do', 'does', 'how', 'what', 'where', 'who', 'when',
      'hi', 'hello', 'hey', 'ok', 'okay', 'chat', 'good', 'morning', 'afternoon', 'evening',
    ...
    if (keywords.length === 0) {
      ...
      const knowledgePrompt = {
        role: 'system',
        content: `You are an expert assistant for a platform connecting users with verified technical experts. Reply concisely and helpfully based only on the experts available on this platform. Do not mention external job platforms or websites. Give answer in max 2-3 lines.`
      };
    ...
    const knowledgePrompt = {
      role: 'system',
      content: `You are an expert assistant for a platform connecting users with verified technical experts. Reply concisely and helpfully based only on the experts available on this platform. Don't mention verified experts in response. Do not mention external job platforms or websites. Give answer in max 2-3 lines.`
    };
